...
const Home = () => {
    ...
    return ( 
        <div>
           ...
           <div className="flex justify-start flex-col gap-10 container  px-10 mx-auto">
                <div className="w-2/3 flex flex-col items-start">
                    ...
                    <div className="starterLine h-48 w-2 -ml-3.5 -mt-14 rounded-t-sm"
              ...
              <div className="starterLine h-48 w-1 -ml-3.5 -mt-24 rounded-t-sm"
                    ...
                    /> 
                <LoginIcon className="loginIcon" sx={{ marginLeft: '-27px', marginTop: '10px', color: '#a0b6cf',scale:'1.3',
                ...
                <div className="w-2/5 login">
                   <UserForm/>
                </div>
               
              </div>
              <div className="flex flex-col">
              <InfoIcon className="loginIcon" sx={{ marginLeft: '-27px', marginTop: '10px', color: '#a0b6cf',scale:'1.3',
                    filter: 'drop-shadow(0px 0px 6px #a0b6cf)'
                }}/>
